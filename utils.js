exports.mpSnippet = function () {
	...
	//return '!function(c,a){if(!a.__SV){var b,d,e,f;window.mixpanel=a,a._i=[],a.init=function(d,g,c){function h(a,b){var c=b.split(".");2==c.length&&(a=a[c[0]],b=c[1]),a[b]=function(){a.push([b].concat(Array.prototype.slice.call(arguments,0)))}}var b=a;for(void 0!==c?b=a[c]=[]:c="mixpanel",b.people=b.people||[],b.toString=function(b){var a="mixpanel";return"mixpanel"!==c&&(a+="."+c),b||(a+=" (stub)"),a},b.people.toString=function(){return b.toString(1)+".people (stub)"},e="disable time_event track track_pageview track_links track_forms track_with_groups add_group set_group remove_group register register_once alias unregister identify name_tag set_config reset opt_in_tracking opt_out_tracking has_opted_in_tracking has_opted_out_tracking clear_opt_in_out_tracking start_batch_senders people.set people.set_once people.unset people.increment people.append people.union people.track_charge people.clear_charges people.delete_user people.remove".split(" "),f=0;f<e.length;f++)h(b,e[f]);var i="set set_once union unset remove delete".split(" ");b.get_group=function(){function c(a){d[a]=function(){call2_args=arguments,call2=[a].concat(Array.prototype.slice.call(call2_args,0)),b.push([e,call2])}}for(var d={},e=["get_group"].concat(Array.prototype.slice.call(arguments,0)),a=0;a<i.length;a++)c(i[a]);return d},a._i.push([d,g,c])},a.__SV=1.2,(b=c.createElement("script")).type="text/javascript",b.async=!0,b.src="undefined"!=typeof MIXPANEL_CUSTOM_LIB_URL?MIXPANEL_CUSTOM_LIB_URL:"file:"===c.location.protocol&&"//cdn.mxpnl.com/libs/mixpanel-2-latest.min.js".match(/^\\/\\//)?"https://cdn.mxpnl.com/libs/mixpanel-2-latest.min.js":"//cdn.mxpnl.com/libs/mixpanel-2-latest.min.js",(d=c.getElementsByTagName("script")[0]).parentNode.insertBefore(b,d)}}(document,window.mixpanel||[])';
};
